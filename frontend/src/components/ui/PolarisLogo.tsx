/* ============================================================
   ...
   - PolarisMark：蓝色圆角方块 + 白色彗星/纸飞机 + 青绿四角星（图形标）。
...
export function PolarisMark({ size = 26, title = 'Polaris' }: { size?: number; title?: string }) {
  return (
    ...
    >
      {/* 圆角方块底 */}
      <path
        d="M38 34.2C38 36.2987 36.2987 38 34.2 38H3.8C1.70132 38 0 36.2987 0 34.2V3.8C0 1.70132 1.70132 0 3.8 0H34.2C36.2987 0 38 1.70132 38 3.8V34.2Z"
        fill={POLARIS_BLUE}
      />
      {/* 白色彗星/纸飞机 */}
      <path
      ...
      <path
        opacity="0.95"
        transform="rotate(45 31.6 13)"
        d="M31.6 10.3C31.76 12.14 32.36 12.84 34.2 13C32.36 13.16 31.76 13.66 31.6 15.5C31.44 13.66 30.84 13.16 29 13C30.84 12.84 31.44 12.14 31.6 10.3Z"
        fill={POLARIS_TEAL}
      />
      <path
        d="M31.6 8.4C31.92 11.88 32.72 12.68 36.2 13C32.72 13.32 31.92 14.12 31.6 17.6C31.28 14.12 30.48 13.32 27 13C30.48 12.68 31.28 11.88 31.6 8.4Z"
        fill="#FFFFFF"
      />
    </svg>
  );
