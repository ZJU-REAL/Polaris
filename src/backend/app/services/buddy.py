...
#:
#: ``kind`` 是**这张卡在问哪一类事**，不是图标名。前端拿它去挑图标和颜色——那是表现，
#: 归前端管；后端要是直接吐 "flask" 这种图标名，改个图标就得动后端。
#:
...
#: 卡片的类别。前端按它挑图标与颜色，认不出的一律给个中性图标，不会因此空掉。
CARD_KINDS = (
    "read",  # 读懂某篇
    "compare",  # 和已有工作比 / 查有没有人做过
    "verify",  # 证据、结果可不可信
    "idea",  # 想法本身
    "experiment",  # 实验进展
    "write",  # 稿子怎么写
...
def _card(kind: str, summary: str, prompt: str) -> Card:
    return {"kind": kind, "summary": summary, "prompt": prompt}


def compose_opening(stats: BuddyStats, *, page_kind: str | None = None) -> tuple[str, list[Card]]:
    """返回 (问句, 四张卡片)。卡片的 prompt 是**用户说的话**，点了就当他这么问。"""
        ...
        "idea": (
            ...
            [
                ...
                _card(
                    "verify",
                    "最弱的一环",
                    "这个想法最站不住的地方在哪？把最可能被审稿人问倒的那一点指出来。",
                ),
                _card(
                    "next",
                    "第一步做什么",
                ...
                _card("cite", "该读哪些", "围绕这个想法，我该先读哪几篇文献才能把背景补齐？"),
            ],
        ),
        "experiment": (
            "这个实验现在怎么样？",
            [
                _card(
                    "experiment",
                    "跑到哪了",
                    "这个实验现在跑到哪一步了？把已有的结果讲一下，它们说明了什么。",
                ),
                _card(
                    "verify",
                    "结果可信吗",
                    "这个实验的结果可信吗？有没有哪些设置或指标会让结论站不住。",
                ),
                _card(
                    "next",
                    "下一轮改什么",
                    "如果要再跑一轮，该改哪个变量、为什么改它，预期会看到什么变化。",
                ),
                _card(
                    "write",
                    "怎么写进去",
                    "把这个实验的结果整理成能写进论文的一段话，包括该配什么图表。",
                ),
            ],
        ),
        "manuscript": (
            ...
            [
                _card(
                    "write", "这节通不通", "帮我看看我正在写的这一节：论证链条通不通，哪里跳步了。"
                ),
                _card(
                    "cite",
                    "还缺哪些引用",
                    "对照这篇稿子的主题，相关工作里还缺哪些该引而未引的文献。",
                ),
                _card("write", "改紧凑些", "把这段改得更紧凑一些：留住意思，去掉绕弯子的地方。"),
                _card(
                    "read", "摘要怎么写", "根据这篇稿子现在的内容，帮我起一版摘要，把贡献说清楚。"
                ),
            ],
        ),
        "library": (
            ...
            [
                _card(
                    "browse",
                    "最近进了什么",
                    "这个文献库最近进了哪些论文？挑出值得优先读的几篇并说明理由。",
                ),
                _card(
                    "browse",
                    "按主题归类",
                    "把这个库里的论文按主题归归类，让我知道它大致覆盖了哪几个方向。",
                ),
                _card(
                    "compare",
                    "共同的思路",
                    "这个库里的工作有哪些反复出现的思路或者共用的技术路线？",
                ),
                _card(
                    "idea", "还缺什么", "从这个库的覆盖情况看，这个方向上还有哪些没被做过的空档？"
                ),
            ],
        ),
        "project": (
            ...
            [
                _card(
                    "browse",
                    "现在到哪了",
                    "帮我理一下这个课题目前的进展：想法、实验、稿子各到什么阶段。",
                ),
                _card(
                    "idea",
                    "还有什么空档",
                    "这个课题所在的方向上还有哪些没被做过的空档，值得我去占。",
                ),
                _card(
                    "next",
                    "下一步做什么",
                    "综合现在的进展，下一步最该动手的是什么？说明为什么是它。",
                ),
                _card(
                    "cite", "该补哪些文献", "围绕这个课题，我还该补读哪些文献才不至于漏掉重要工作？"
                ),
            ],
        ),
        "daily": (
            ...
            [
                _card(
                    "search",
                    "挑相关的",
                    "从今天的新论文里挑出和我的研究方向相关的几篇，并说明为什么相关。",
                ),
                _card(
                    "read", "今天值得读的", "今天这批新论文里有哪些值得一读？给我理由，别只给标题。"
                ),
                _card(
                    "browse",
                    "按主题归类",
                    "把今天的新论文按主题归归类，让我快速知道今天大致发生了什么。",
                ),
                _card(
                    "compare",
                    "和我的库比",
                    "今天这批里有没有和我库里已有工作直接相关的？指出来并说明关系。",
                ),
            ],
        ),
    }
        ...
        return (
            ...
            [
                _card(
                    "experiment",
                    "跑到哪了",
                    "我现在有实验在跑，帮我看看各自跑到哪一步了、结果说明什么。",
                ),
                _card(
                    "verify",
                    "有没有问题",
                    "检查一下在跑的实验有没有异常：指标不动、报错、或者设置上的坑。",
                ),
                _card(
                    "next",
                    "下一步做什么",
                    "根据现在的结果，下一步该做什么？要不要调整设置再跑一轮。",
                ),
                _card(
                    "write",
                    "怎么写进去",
                    "把现在的实验结果整理成能写进论文的一段话，包括该配什么图表。",
                ),
            ],
        )
    if stats.manuscripts_active:
        return (
            "稿子写到哪了？",
            [
                _card("write", "现在的问题", "帮我看看在写的这篇稿子现在最大的问题是什么。"),
                _card(
                    "cite", "还缺哪些引用", "对照稿子的主题，相关工作里还缺哪些该引而未引的文献。"
                ),
                _card("next", "接下来补哪节", "接下来最该补的是哪一节？说明为什么是它。"),
                _card("read", "摘要怎么写", "根据稿子现在的内容，帮我起一版摘要，把贡献说清楚。"),
            ],
        )
        ...
        return (
            ...
            [
                _card(
                    "browse",
                    "串一串",
                    "把我在读的这几篇串一串：它们各自在回答什么问题，彼此什么关系。",
                ),
                _card("compare", "共同点", "我在读的这几篇有什么共同的思路或者共用的方法？"),
                _card(
                    "read", "挑一篇细讲", "从我在读的这几篇里挑一篇最值得细读的，讲清楚它做了什么。"
                ),
                _card("idea", "能想到什么", "从我在读的这几篇里，能引出什么值得做的研究想法？"),
            ],
        )
    if stats.ideas_recent:
        return (
            ...
            [
                _card(
                    "idea", "哪个值得做", "我最近攒了一些想法，帮我看看哪个最值得先做，理由是什么。"
                ),
                _card(
                    "compare",
                    "有人做过吗",
                    "帮我查查这些想法里有没有已经被人做过的，找出最接近的工作。",
                ),
                _card(
                    "next", "拆成第一步", "挑一个想法，把它拆成可以动手的步骤，告诉我第一步做什么。"
                ),
                _card("cite", "该读哪些", "围绕这些想法，我该先读哪几篇文献把背景补齐？"),
            ],
        )
    if stats.saved_recent:
        return (
            ...
            [
                _card(
                    "browse",
                    "共同的线索",
                    "把我这周收的论文串一串，看看有没有共同的线索或者反复出现的问题。",
                ),
                _card(
                    "browse", "按主题归类", "把我这周收的论文按主题归归类，让我知道自己在关注什么。"
                ),
                _card(
                    "read", "哪篇最该细读", "我这周收的论文里，哪一篇最值得花时间细读？给我理由。"
                ),
                _card("idea", "能想到什么", "从我这周收的论文里，能引出什么值得做的研究想法？"),
            ],
        )
    if stats.daily_today:
        return (
    ...
    if stats.saved_total:
        return (
            "今天想从哪儿看起？",
            [
                _card("read", "值得重读的", "我的文献库里有哪些值得重读的论文？挑几篇并说明理由。"),
                _card(
                    "search",
                    "找某个方向",
                ...
                _card(
                    "browse", "最近的进展", "我关注的方向最近有什么新进展？把值得注意的几篇讲一讲。"
                ),
                _card("idea", "能想到什么", "从我库里已有的论文，能引出什么值得做的研究想法？"),
            ],
        )
    ...
    return (
        ...
        [
            ...
            _card("read", "最近有什么新的", "最近有哪些值得读的新论文？挑几篇讲讲它们在做什么。"),
            _card("about", "你能做什么", "介绍一下你能帮我做什么，按我在平台上会用到的场景说。"),
            _card("next", "怎么开始", "我想开始一个新课题，从零开始的话该怎么走？"),
        ],
    )
